...
public class IChall6 {
    ...
    static class Book{
        ...
        public boolean equals(Object obj){
            ...
            return (book.title.equals(this.title) && book.auth.equals(this.auth) && book.gen.equals(this.gen) && book.pub.equals(this.pub) && book.pg == this.pg);
        }
    }
    ...
    public static void main(String[] args){
        ...
        Book test = new Book("Aa","O","L","P",7 ,90);
        Book test1 = new Book("AA","O","L","P",7 ,90);
        Book test2 = new Book("Aa","no","L","P",7 ,90);
        Book test3 = new Book("no","O","L","P",7 ,90);
        Book test4 = new Book("no","no","no","no",7 ,90);
        Book test5 = new Book("Aa","O","L","P",7 ,90);
